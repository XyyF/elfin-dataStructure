...
describe('[SSCLList] 单向循环链表', () => {
    ...
    describe('实例func__push', () => {
        ...
        it('push', () => {
            ...
            expect(llist.head.next.next).toEqual(llist.tail)
            // 转化为数组
            ...
            expect(llist.head.next.next.next).toEqual(llist.tail)
            // 转化为数组
    ...
    describe('实例func__pop', () => {
        ...
        it('pop', () => {
            ...
            // 链表属性 - 长度、尾节点元素、尾节点后驱指针
            expect(llist.length).toBe(1)
            expect(llist.head.next.element).toEqual(1)
            expect(llist.head.next.next).toEqual(llist.tail)
            // 转化为数组
            expect(llist.transToArray()).toEqual([1])
    ...
    describe('实例func__unshift', () => {
        ...
        it('unshift', () => {
            ...
            // 链表属性 - 长度、节点元素、节点后驱指针
            expect(llist.length).toBe(2)
            expect(llist.head.next.next.element).toEqual(1)
            expect(llist.head.next.next.next).toEqual(llist.tail)
            // 转化为数组
